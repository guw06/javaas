...
- 📋 **Буфер обмена** — чтение содержимого буфера
...
| `буфер` | Прочитать буфер обмена | "Что в буфере обмена?" |
| `статистика` | Статистика системы | "Покажи статистику" |
...
- **SQLite JDBC 3.45.1.0** — встроенная база данных
