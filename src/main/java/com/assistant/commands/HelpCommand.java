...
public class HelpCommand implements Command {
    ...
    public String execute(String input) {
        ...
        sb.append("Организация и умные режимы:\n");
        sb.append("  - покажи настройки\n");
        sb.append("  - отвечай коротко\n");
        sb.append("  - поставь город Алматы\n");
        sb.append("  - проверь нейросеть\n");
        sb.append("  - добавь задачу закончить проект\n");
        sb.append("  - покажи задачи\n");
        sb.append("  - сводка дня\n");
        sb.append("  - режим учебы\n");
        sb.append("  - режим работы\n");
        sb.append("  - привычка \"доброе утро\" = сводка дня\n");
        sb.append("  - когда я скажу \"домашка\", открой последний Word документ\n");
        sb.append("  - что ты сегодня делала\n");
        sb.append("  - найди документ про проект\n\n");
